...
A structural signal just hit the prospect's company: funding, hiring spike, leadership change, M&A, or similar. Reference the signal plainly and say the implication in plain language. Friend-tone.
...
Use contractions. Lowercase is fine. No em dashes. No URLs. No pricing. One or two sentences maximum. Name the signal plainly and add a one-beat implication (e.g. "that usually means the ops side gets messy for a quarter").
