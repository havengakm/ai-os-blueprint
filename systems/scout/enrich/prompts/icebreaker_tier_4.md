...
Examples (Tier 4 style — mirror the simplicity, not the words):

ALLOWED:
{{"icebreaker": "Saw the Iroko work. The modular icon for organised structure instead of the usual sustainability visuals is a nice call."}}

{{"icebreaker": "Noticed the Ravenna case study. The 3x pipeline framing with the client quote underneath actually sells itself."}}

{{"icebreaker": "Read the bit about infrastructure-grade nature restoration on the Iroko page. That phrase does a lot of work."}}
...
If the citable details don't give you a real named client, project, or specific craft choice, return {{"icebreaker": ""}} instead.
