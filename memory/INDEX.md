...
| Plan 2 (email full-loop — second-pass scope 2026-04-26) | Not started | 7 phases: hardening + ESP eval (3-way) + Beacon email + reply runtime + cost optimiser foundation + Optimizer v1 + productisation. LinkedIn deferred to Plan 3. Plan doc: `docs/superpowers/plans/2026-04-26-plan-2-beacon.md`. Per `feedback_esp_evaluation_pending`, `feedback_linkedin_modular_plan2`, `feedback_cost_optimiser_continuous_concern` | Kirsten + Claude |
